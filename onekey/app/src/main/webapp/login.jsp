<%@page import="com.kerbores.onkey.bean.Application"%>
								...
								<div class="widget-body">
									<div class="widget-main">
										...
										<form id="loginForm">
											<fieldset>
												<label class="block clearfix"> <span class="block input-icon input-icon-right"> <input type="text" class="form-control" placeholder="请输入用户名"
														name="userName" id="user" value="${obj.data.userName }" data-type="required" data-error="请输入用户名" /> <i class="ace-icon fa fa-user"></i>
												</span>
												</label> <label class="block clearfix"> <span class="block input-icon input-icon-right"> <input type="password" class="form-control" placeholder="请输入密码" id="password"
														name="password" value="${obj.data.password }" data-type="required" data-error="请输入密码" /> <i class="ace-icon fa fa-lock"></i>
												</span>
												</label> <label class="block clearfix">
													<div class="input-group">
														<input type="text"  id="captcha" class="form-control search-query" placeholder="请输入验证码" name="captcha" data-type="required" data-error="请输入验证码" /> <span class="input-group-btn">
															<a href="javascript:;" class="captchaRefresh"> <img id="captcha" title="点击刷新验证码" src="${base}/captcha" height="34px">
														</a>
														</span>
													</div>
												</label>
												...
												<div class="clearfix">
													<label class="inline"> <input type="checkbox" class="ace" name="checkBox" id="rememberMeCheckBox" ${obj.data.rememberMe } /> <span class="lbl"> 记住我</span>
													</label>
										...
										<div class="social-login center">
											...
											<h5 class="pink" id="id-company-text">CopyRight &copy;2016 重庆XXX科技有限公司</h5>
										</div>
